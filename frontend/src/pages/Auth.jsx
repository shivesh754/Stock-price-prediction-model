...
const Auth = () => {
  ...
  // Re-render Google button when switching modes
  useEffect(() => {
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-0 glass-panel overflow-hidden">
        ...
        <div className="p-8 sm:p-10 lg:p-12 flex flex-col justify-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {/* Google Sign-In — real rendered button if configured, fallback otherwise */}
            {GOOGLE_CLIENT_ID ? (
              <div
                id="google-signin-btn"
                className="flex items-center justify-center rounded-lg overflow-hidden min-h-[44px]"
              />
            ) : (
              <button
                type="button"
                ...
                onClick={() =>
                  setError(
                    'Google Sign-In requires configuration. Set VITE_GOOGLE_CLIENT_ID in your .env file.'
                  )
                }
              >
